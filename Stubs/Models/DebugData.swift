...
struct DebugData {
    static let artists = ["Adele", "Beyoncé", "Drake", "Green Day", "Ed Sheeran", "Kendrick Lamar", "Fall Out Boy", "Rihanna", "John Mayer" ,"Thrice", "Bruno Mars" ,"The Weeknd", "Ariana Grande","Billie Eilish","Post Malone", "A Day to Remember", "Polyphia", "Dua Lipa" ,"Travis Scott", "Taking Back Sunday", "Wolves at the Gate","Bad Bunny","Halsey", "Harry Styles", "Lana Del Rey" ,"Sia", "Khalid", "Rosalía", "Sam Smith", "Tame Impala"]
